	...
	<div align="center">
		...
		<div align="left" style="color: #6E6E6E; width: 70%; margin-top: 4%;">
			...
			<table style="width: 100%">
				<tr>
					<td style="float: left; font-size: 24px;">Listar de <strong>Categoria
							de Produto</strong>
					</td>
					<td style="float: right;"><a href="exibirIncluirCategoriaProduto"
						class="btn btn-primary" role="button">Incluição de categoria</a></td>
				</tr>
			</table>
			</p>
