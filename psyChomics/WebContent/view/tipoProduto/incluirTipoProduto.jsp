		...
		<div align="left" style="color: #6E6E6E; width: 70%; margin-top: 4%;">
			...
			<p>
				<table style="width: 100%">
					<tr>
						<td style="float: left; font-size: 24px;">Incluir <strong>Tipo de Produto</strong> </td>
			...
			<form action="incluirTipoProduto" method="post">
				...
				<br />
  				...
  				<a href="listarTipoProduto" class="btn btn-danger" role="button">Cancelar</a> &nbsp;
